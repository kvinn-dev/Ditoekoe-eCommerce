...
const categories = [
    ...
    { id: 2, name: 'Fashion Pria', slug: 'fashion-pria' },
    { id: 3, name: 'Fashion Wanita', slug: 'fashion-wanita' },
    { id: 4, name: 'Kesehatan & Kecantikan', slug: 'kesehatan-kecantikan' },
    { id: 5, name: 'Makanan & Minuman', slug: 'makanan-minuman' },
    { id: 6, name: 'Hobi & Alat Tulis', slug: 'hobi-alattulis' },
        ...
        <>
            ...
            <div className="min-h-screen text-gray-900">
                ...
                <div className="flex items-center justify-center w-full gap-4 pt-5">
                    {/* Strip kiri */}
                    <div className="flex-1 max-w-[50px] h-[1px] bg-gray-400 dark:bg-gray-700" />

                    {/* === ELEMEN LAMA (TIDAK DIUBAH) === */}
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="flex px-0.5 py-2 space-x-1 text-white font-medium -mt-1">
                            {[timeLeft.h, timeLeft.m, timeLeft.s].map((t, i) => (
                                <span
                                    key={i}
                                    className="bg-[#191919] dark:bg-[#000] w-8 h-6 flex items-center justify-center rounded text-sm"
                                >
                                    {t}
                                </span>
                            ))}
                ...
                <section className="bg-white">
                    <div className="container mx-auto max-w-6xl">
                        {/* FLASH SALE HEADER - Tata letak seperti gambar */}
                        <div className="my-4">
                            {/* HEADER BANNER - Orang besar di atas */}
                        ...
                        <div className="mb-6">
                            <div className="flex ml-2 gap-7.5 overflow-x-auto pb-3 scrollbar-hide items-center">
                                {categories.map((c) =>
                                    c.slug !== 'lainnya' ? (
                                        <button
                                            key={c.id}
                                        ...
                                        <button
                                            ...
                                            className="px-5 py-1.5 rounded-full text-sm font-medium bg-gray-100 hover:bg-gray-200 text-gray-700 flex items-center gap-1.5 flex-shrink-0 transition"
                                        >
                                            Lainnya
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            >
                                {moreCategories.map((item) => (
                                    <button
                                        ...
                                        className="block w-full text-left px-4 py-2.5 mt-1 mb-1 text-sm text-gray-700 hover:bg-gray-100 transition"
                                    >
                                        {item.name}
                                    </button>
                                ))}
